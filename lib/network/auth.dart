...
import 'package:cash_withdraw/data/CashWithdrawDB.dart';
...
class AuthDataProvider {
  final String _baseUrl = 'http://server.url/api';

  late http.Client httpClient;
  late SharedPreferences sharedPreferences;

  CashWithdrawDB tenaye = CashWithdrawDB();
  ...
  Future<void> saveTokens(UserModel user) async {
